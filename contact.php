...
<head>
    <meta charset="utf-8" />
    <title>Beatriz Soutilha</title>
    <!-- Meta Data -->
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <meta name="author" content="Beatriz Soutilha" />
    <meta name="description" content="Portifólio de trabalhos realizados e formação de Beatriz Soutilha" />
    <!-- Styles -->
            ...
            <header class="header box">
                <div class="header__left">
                    <div class="header__photo">
                        <img class="header__photo-img" src="assets/img/profile.jpeg" alt="Beatriz Soutilha">
                    </div>
                    <div class="header__base-info">
                        <h4 class="title titl--h4">Beatriz Soutilha</h4>
                        <div class="status">Estudante de Programação/div>
                        <ul class="header__social">
                            <li>
                                <a href="https://www.linkedin.com/in/beatriz-soutilha-02437b132/">
                                    <i class="font-icon icon-linkedin"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://github.com/BeatrizSoutilha">
                                    <i class="font-icon icon-github"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://www.youtube.com/channel/BeatrizSoutilha">
                                    <i class="font-icon icon-youtube"></i>
                                </a>
                            </li>
                            <li>
                                <a href="https://twitter.com/BeatrizSoutilha">
